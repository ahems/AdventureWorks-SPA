...
{
    public partial class AddSalesltCustomeraddress
    {
        [Inject]
        ...
        {
            salesltCustomeraddress = new AdventureWorks.Server.Models.adventureworks.SalesltCustomeraddress();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.CreateSalesltCustomeraddress(salesltCustomeraddress);
