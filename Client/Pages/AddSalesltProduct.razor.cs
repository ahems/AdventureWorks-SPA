...
{
    public partial class AddSalesltProduct
    {
        [Inject]
        ...
        {
            salesltProduct = new AdventureWorks.Server.Models.adventureworks.SalesltProduct();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.CreateSalesltProduct(salesltProduct);
