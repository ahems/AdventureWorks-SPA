...
{
    public partial class AddSalesltProductmodelproductdescription
    {
        [Inject]
        ...
        {
            salesltProductmodelproductdescription = new AdventureWorks.Server.Models.adventureworks.SalesltProductmodelproductdescription();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.CreateSalesltProductmodelproductdescription(salesltProductmodelproductdescription);
