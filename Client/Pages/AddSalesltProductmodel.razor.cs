...
{
    public partial class AddSalesltProductmodel
    {
        [Inject]
        ...
        {
            salesltProductmodel = new AdventureWorks.Server.Models.adventureworks.SalesltProductmodel();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.CreateSalesltProductmodel(salesltProductmodel);
