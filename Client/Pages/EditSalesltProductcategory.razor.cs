...
{
    public partial class EditSalesltProductcategory
    {
        [Inject]
        ...
        {
            salesltProductcategory = await adventureworksService.GetSalesltProductcategoryByProductCategoryId(productCategoryId:ProductCategoryId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.UpdateSalesltProductcategory(productCategoryId:ProductCategoryId, salesltProductcategory);
