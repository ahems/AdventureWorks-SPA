...
{
    public partial class AddSalesltSalesorderdetail
    {
        [Inject]
        ...
        {
            salesltSalesorderdetail = new AdventureWorks.Server.Models.adventureworks.SalesltSalesorderdetail();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.CreateSalesltSalesorderdetail(salesltSalesorderdetail);
