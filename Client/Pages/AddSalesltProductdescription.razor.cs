...
{
    public partial class AddSalesltProductdescription
    {
        [Inject]
        ...
        {
            salesltProductdescription = new AdventureWorks.Server.Models.adventureworks.SalesltProductdescription();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await adventureworksService.CreateSalesltProductdescription(salesltProductdescription);
